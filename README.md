...
Gerpy es un ERP financiero y operativo multi-tenant construido con Next.js
App Router, TypeScript, Prisma ORM y PostgreSQL. Su arquitectura combina
sesiones revocables mediante JTI, RBAC por tenant y sucursal, Row-Level
Security, contabilización idempotente y procesamiento asíncrono mediante el
patrón Outbox.

    ...
    <OnboardingLayout currentStep={4}>
      ...
      >
          ...
          {plans.map((plan) => {
            ...
            return (
              <Card
                key={plan.name}
                size="sm"
                className={plan.highlighted ? "border-primary/40 shadow-panel" : ""}
              >
                <CardHeader>
                  <div className="flex items-start justify-between gap-3">
                    ...
                    {plan.highlighted ? (
                      <Badge className="rounded-md">Popular</Badge>
                    ) : null}
                  </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <OnboardingNavButton href="/onboardingAdmin/setup" variant="outline">
            Regresar
          </OnboardingNavButton>
        </div>
      </OnboardingPanel>

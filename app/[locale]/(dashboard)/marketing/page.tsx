...
export default async function MarketingPage({
  ...
  const chartLabels: Record<Locale, { title: string; description: string }> = {
    es: {
      ...
      description: "Tasa de conversión por etapa del proceso comercial.",
    },
    en: {
      title: "Conversion funnel",
      description: "Conversion rate per stage of the sales process.",
    },
    fr: {
      title: "Entonnoir de conversion",
      description: "Taux de conversion par étape du processus commercial.",
    },
  };

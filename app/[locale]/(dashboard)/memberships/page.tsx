...
export default async function MembershipsPage({
  ...
  const config = moduleConfigs["memberships"];

  const chartLabels: Record<Locale, { title: string; description: string }> = {
    es: {
      title: "Crecimiento de membresías",
      description: "Evolución mensual de planes activos.",
    },
    en: {
      title: "Membership growth",
      description: "Monthly evolution of active plans.",
    },
    fr: {
      title: "Croissance des adhésions",
      description: "Évolution mensuelle des plans actifs.",
    },
  };

...
export default async function PosPage({
  ...
  const config = moduleConfigs["pos"];

  const chartLabels: Record<Locale, { title: string; description: string }> = {
    es: {
      title: "Ventas por hora",
      description: "Distribución de tickets a lo largo del día.",
    },
    en: {
      title: "Sales per hour",
      description: "Ticket distribution throughout the day.",
    },
    fr: {
      title: "Ventes par heure",
      description: "Distribution des tickets au cours de la journée.",
    },
  };

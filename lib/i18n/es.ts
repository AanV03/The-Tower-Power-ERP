export const es = {
  ...
  integrations: {
    title: "Consola de Integraciones",
    subtitle: "Administra conexiones de terceros, webhooks y audita eventos en tiempo real.",
    ...
    tabs: {
      ...
      console: "Monitoreo Técnico",
    },
    metrics: {
      activeConnections: "Conexiones Activas",
      pendingOutbox: "Outbox Pendiente",
    ...
    stepper: {
      ...
      events: "Suscripción",
      test: "Prueba",
      apiKeyLabel: "API Key / Token de Acceso",
      apiKeyPlaceholder: "Ingresa tu API Key de {name}",
      selectEventsLabel: "Selecciona los eventos a sincronizar",
      webhookLabel: "URL del Webhook de Gerpy",
    ...
    outbox: {
      title: "Bitácora de Eventos (Outbox)",
      description: "Historial técnico de sincronizaciones y eventos enviados.",
      eventId: "ID Evento",
      ...
      viewPayload: "Ver JSON",
      payloadTitle: "Detalle del Evento y Log de Sincronización",
      payloadCopied: "¡Payload copiado al portapapeles!",
      retrySuccess: "Evento reencolado con éxito",
      emptyState: "No se encontraron eventos en la bitácora.",
    },
    banner: {
      errorTitle: "Alerta de sincronización",
      errorMessage: "WhatsApp Cloud API reportó múltiples fallos de autenticación (Token Expirado). Las notificaciones automáticas están en cola.",
    }
  },
} as const;

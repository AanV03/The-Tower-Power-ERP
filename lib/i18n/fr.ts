export const fr = {
  ...
  integrations: {
    title: "Console d'Intégrations",
    subtitle: "Goutez les connexions tierces, les webhooks et auditez les événements en temps réel.",
    searchPlaceholder: "Rechercher une intégration...",
    filterAll: "Tous",
    filterConnected: "Connectés",
    filterInactive: "Inactifs",
    filterError: "Erreur API",
    tabs: {
      marketplace: "Marketplace d'Apps",
      console: "Surveillance Technique",
    },
    metrics: {
      activeConnections: "Connexions Actives",
      pendingOutbox: "Outbox en Attente",
    ...
    stepper: {
      ...
      events: "Abonnement",
      test: "Test",
      apiKeyLabel: "Clé API / Jeton d'Accès",
      apiKeyPlaceholder: "Saisissez votre clé API {name}",
      selectEventsLabel: "Sélectionnez les événements à synchroniser",
      webhookLabel: "URL du Webhook Gerpy",
    ...
    outbox: {
      title: "Journal des Événements (Outbox)",
      description: "Historique technique des synchronisations et événements envoyés.",
      ...
      retry: "Réessayer",
      retrying: "Réessai...",
      viewPayload: "Voir JSON",
      payloadTitle: "Détails de l'Événement et Journal de Synchronisation",
      payloadCopied: "Payload copié dans le presse-papiers !",
      retrySuccess: "Événement réintégré avec succès",
      emptyState: "Aucun événement trouvé dans le journal.",
    },
    banner: {
      errorTitle: "Alerte de Synchronisation",
      errorMessage: "L'API WhatsApp Cloud a signalé plusieurs échecs d'authentification (Jeton Expiré). Les notifications automatiques sont en attente.",
    }
  },
} as const;

...
- **Subscriptions & Access**: 
  - [validate/route.ts](file:///c:/Dev/Gerpy/app/api/access/validate/route.ts)
  - [subscriptions/route.ts](file:///c:/Dev/Gerpy/app/api/memberships/subscriptions/route.ts)
- **POS & Inventory**: 
  - [pos-service.ts](file:///c:/Dev/Gerpy/lib/api/pos-service.ts)
  - [sales/route.ts](file:///c:/Dev/Gerpy/app/api/pos/sales/route.ts)
- **UI Components**: 

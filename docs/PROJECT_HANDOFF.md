...
- Some text in `HrClient` appears mojibake/encoding-corrupted, for example `Ãšltimo registro`, `CompensaciÃ³n`, `PÃ¡gina`. This existed in the UI branch and should be cleaned later.
